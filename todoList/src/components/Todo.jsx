...
function Todo() {
  return (
    <div className="mb-3 flex flex-wrap items-center justify-between w-full">
      <div className="flex flex-wrap gap-3 items-center justify-baseline">
        <Input width={"w-3"} height={"h-3"} />
        <p className="text-white font-light">A simple todo</p>
      </div>
